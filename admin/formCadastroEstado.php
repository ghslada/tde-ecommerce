                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-floating mb-3">
                                    ...
                                    <label for="inputNome">Nome do Estado: </label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input class="form-control" name="UF" id="inputNome" type="text" value="" />
                                    <label for="inputNome">UF: </label>
                                </div>
                                <div class="mt-4 mb-0">
                                    <button type="submit" name="submit" class="d-grid"><p class="btn btn-primary btn-block">Cadastrar Estado</p></button>
                                </div>
                                ');
                                ?>
                            </form>
