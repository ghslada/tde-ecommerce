...
function avisoDeleteUsuario($result){
    if(($result)){
        ...
        <div class="row">
            <div class="btn-lg btn-warning rounded-0" style="height: 15%;">
                ...
                <a href="alterarUsuario.php" class="btn btn-danger mx-1" style="float: right;">X</a>
            </div>
        </div>
        <div class="row mt-auto" style="height: 80%">
            <div class="btn bg-white rounded-0 p-3" style="height: 100%">
                <h2 class="mt-5" style="font-size: 200%">Delete realizado com sucesso.</h2>
            </div>
        </div>
    </div>');
        ...
        <div class="row mt-auto" style="height: 80%">
            <div class="btn bg-white rounded-0 p-3" style="height: 100%">
                <h2 class="mt-5" style="font-size: 200%">Delete falhou.</h2>
            </div>
        </div>
    </div>';
    }
